...
#-------------------------------------------------------------------------
#-------------------------------------------------------------------------
def train_epoch(dataloader : DataLoader, encoder_rnn : EncoderRNN, decoder_rnn : DecoderRNN, 
    ...
    for idx, data in enumerate(dataloader):
        ...
        decoder_outputs, _, _ = decoder_rnn(
...
#-------------------------------------------------------------------------
#-------------------------------------------------------------------------
def train(train_dataloader : DataLoader, encoder_rnn : EncoderRNN, decoder_rnn : DecoderRNN, 
    ...
    decoder_optimizer = optim.Adam(decoder_rnn.parameters(), lr=learning_rate)
...
##########################################################################
#-------------------------------------------------------------------------
def execute_part3(encoder_rnn, decoder_attn_rnn, input_lang_obj, output_lang_obj, device, EOS_token, pairs, plot_losses):
    encoder_rnn.eval()
...
#-------------------------------------------------------------------------
#-------------------------------------------------------------------------
def evaluateAndShowAttention(input_sentence, encoder_rnn, decoder_rnn, 
                             input_lang_obj, output_lang_obj, device, EOS_token):
...
#-------------------------------------------------------------------------
#-------------------------------------------------------------------------
def execute_part4(encoder_rnn, decoder_rnn, input_lang_obj, output_lang_obj,
                  device, EOS_token):
    sentences_to_test = [
...
execute_part4(
    encoder_rnn     = result_part2['encoder_rnn'], 
    decoder_rnn     = result_part2['decoder_attn_rnn'], 
    input_lang_obj  = result_part2['input_lang_obj'], 
    output_lang_obj = result_part2['output_lang_obj'],
    device          = result_part2['device'],
    EOS_token       = result_part2['EOS_token']
